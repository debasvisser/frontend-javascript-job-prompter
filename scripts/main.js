...
console.log(`${departmentChoice} is een leuke afdeling om te werken. Er werken op de moment ${departments[departmentChoice].numberOfEmployees} medewerkers.`)
...
//     case '3':
//
//         const selectedJob = departments[departmentChoice].jobs[functionChoice];
//
//         console.log(`Je koost ${selectedJob.title}. Een uitdagende rol! ${selectedJob.description}`);
